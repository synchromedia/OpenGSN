 ...
 *
 */
@Command(scope = "gsn-facilityManager", name = "getArchive", description="Get Archive data of a given resource")
public class GetArchiveShellCommand extends OsgiCommandSupport {
	...
	@Argument(index = 1, name = "startDate", description = "startDate", required = true, multiValued = false)
	private String startDate;
	@Argument(index = 2, name = "endDate", description = "endDate", required = true, multiValued = false)
	...
	protected Object doExecute() throws Exception {
		...
		if(manager != null){
			...
			if (r != null) {
				System.out.println(manager.getArchiveDataByRangDate(startDate, endDate, r.getId()));
			}else
