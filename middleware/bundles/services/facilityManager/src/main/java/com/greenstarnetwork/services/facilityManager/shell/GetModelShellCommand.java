 ...
 *
 */
@Command(scope = "gsn-facilityManager", name = "getModel", description="Get data model of a given resource")
public class GetModelShellCommand extends OsgiCommandSupport {
