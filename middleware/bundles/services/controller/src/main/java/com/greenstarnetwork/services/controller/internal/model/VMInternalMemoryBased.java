...
public class VMInternalMemoryBased extends AbstractVMInternal {


	public VMInternalMemoryBased(VirtualMachine vm, int coreNumber, int memorySizeMB, Host sourceHost) {
	...
	public int compareTo(Object obj) {
		VMInternalMemoryBased vm = (VMInternalMemoryBased)obj;
		if (this.getMemory()<vm.getMemory())
			return -1;
		else if (this.getMemory()>vm.getMemory())
			return 1;
		else return 0;
