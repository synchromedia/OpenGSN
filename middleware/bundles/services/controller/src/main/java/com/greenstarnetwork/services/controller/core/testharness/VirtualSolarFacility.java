...
import com.greenstarnetwork.services.controller.core.testharness.exceptions.BadTimeException;
import com.greenstarnetwork.services.controller.core.testharness.exceptions.CannedProductionProcessingException;
import com.greenstarnetwork.services.controller.core.testharness.utils.CannedDayProduction;
import com.greenstarnetwork.services.controller.core.testharness.vmmodel.VMHarness;
...
public class VirtualSolarFacility extends AbstractVirtualFacility {
	...
	public void refreshModel(long currentTime) throws BadTimeException, CannedProductionProcessingException {
		...
		for(Host host : hosts) {
			...
			if (this.getRemainingMaxLoadHours()>0){
				host.setStatus("GREEN");
			}else{
				host.setStatus("NONGREEN");
			}
		}
	}
