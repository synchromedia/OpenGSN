...
import com.greenstarnetwork.services.controller.core.testharness.utils.FacilitySerializer;
...
public class ControllerRunner {
	...
	public ControllerRunner(IController controller, IFacilityLocator facilityLocator, long startTime, int interval, FacilityOpHourSpec opHrSpec) throws FacilityRetrievalException {
	...
	public ControllerRunner(IController controller, IFacilityLocator facilityLocator, FacilityOpHourSpec opHrSpec) throws FacilityRetrievalException  {
