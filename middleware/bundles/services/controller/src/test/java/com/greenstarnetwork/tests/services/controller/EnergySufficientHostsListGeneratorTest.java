...
/**
 * This class will test the EnergySufficientHostsListGenerator class. 
 * 
 * 
...
public class EnergySufficientHostsListGeneratorTest extends TestCase {
	 ...
	 * 
	 */
	public void testGoodHostsListGenerator() {
		EnergySufficientHostsListGenerator energySufficientHostsListGenerator = new EnergySufficientHostsListGenerator();
		HostList hostList = energySufficientHostsListGenerator.getEnergySufficientHostsList(new HostList());
		Assert.notNull(hostList, "host list plan is null");
	}
}
