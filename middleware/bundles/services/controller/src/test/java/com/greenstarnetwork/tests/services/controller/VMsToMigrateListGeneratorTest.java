...
/**
 * This class will test the VMsToMigrateListGenerator class. 
 * 
 * 
...
public class VMsToMigrateListGeneratorTest extends TestCase {
	 ...
	 * 
	 */
	public void testVMsToMigrateListGenerator() {
		VMsToMigrateListGenerator vmsToMigrateListGenerator = new VMsToMigrateListGenerator();
		
		VMList vmList = vmsToMigrateListGenerator.getVMsToMigrateList(new HostList());
		Assert.notNull(vmList, "VM list plan is null");
	}
}
