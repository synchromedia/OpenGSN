...
public class ShowVoltSensorAction extends BasicAction {
	
	public static final String ACTION = "ShowVoltSensorAction";
	
	public ShowVoltSensorAction() {
		super(ACTION);
	...
	private void initializeCommandsList(){
		...
		commandsList.add("ShowVoltSensorCommand");
