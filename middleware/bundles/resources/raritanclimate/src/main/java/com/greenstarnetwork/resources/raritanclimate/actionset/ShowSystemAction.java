...
public class ShowSystemAction extends BasicAction {
	
	public static final String ACTION = "ShowSystemAction";
	
	public ShowSystemAction() {
		super(ACTION);
	...
	private void initializeCommandsList(){
		...
		commandsList.add("ShowSystemCommand");
