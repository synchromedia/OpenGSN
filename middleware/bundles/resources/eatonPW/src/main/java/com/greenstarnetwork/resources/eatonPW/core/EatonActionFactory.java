...
import com.greenstarnetwork.resources.eatonPW.actionset.RefreshAction;
import com.greenstarnetwork.resources.eatonPW.actionset.SetOutletConsumerAction;
import com.greenstarnetwork.resources.eatonPW.actionset.SysDescrAction;
 ...
 *
 */
public class EatonActionFactory implements IActionFactory{

	public IAction createAction(String actionId) throws ActionException {
		if (actionId.equals(SysDescrAction.ACTION)){
			return new SysDescrAction();
	...
	public List<String> getActionNames() {
		...
		actions.add(SysDescrAction.ACTION);
