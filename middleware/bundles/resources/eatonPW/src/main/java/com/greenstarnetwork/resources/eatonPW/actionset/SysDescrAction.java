 ...
 *
 */
public class SysDescrAction extends BasicAction{

	public static final String ACTION = "SysDescrAction";
	
	public SysDescrAction() {
		super(ACTION);
	...
	private void initializeCommandsList(){
		...
		commandsList.add(SysDescrCommand.COMMAND);
	...
	public void executeAction() throws ActionException
	{
		try {
			...
			e.printStackTrace();
			throw new ActionException("SysDescrAction failed!", e);
		}
	}
}
