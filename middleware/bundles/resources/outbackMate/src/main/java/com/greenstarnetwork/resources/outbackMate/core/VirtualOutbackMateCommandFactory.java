...
import com.greenstarnetwork.resources.outbackMate.commandset.VirtualTraceCommand;
 ...
 *
 */
public class VirtualOutbackMateCommandFactory implements ICommandFactory{

	public ICommand createCommand(String commandId) throws CommandException 
	{
		if (commandId.equals(VirtualTraceCommand.COMMAND))
			return new VirtualTraceCommand();
		else
