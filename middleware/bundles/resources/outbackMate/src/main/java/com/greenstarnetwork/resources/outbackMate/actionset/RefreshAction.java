 ...
 */
package com.greenstarnetwork.resources.outbackMate.actionset;
...
/**
 * RefreshAction is an IaaS-based implementation of the gmTrace tool.
 * Refer to OutBack Mate Green Monitor document for information about gmTrace.
 * @author knguyen
 *
 */
public class RefreshAction extends BasicAction{
	...
	private void initializeCommandsList(){
		...
		commandsList.add(TraceCommand.COMMAND);
