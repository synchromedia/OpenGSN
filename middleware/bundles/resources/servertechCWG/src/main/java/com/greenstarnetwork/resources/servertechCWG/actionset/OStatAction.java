...
public class OStatAction extends AbstractActionWithCommandSet{

	public static final String ACTION = "OStatAction";
	Logger logger = LoggerFactory.getLogger(OStatAction.class);
