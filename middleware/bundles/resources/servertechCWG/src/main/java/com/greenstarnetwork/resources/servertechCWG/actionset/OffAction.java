...
public class OffAction extends AbstractActionWithCommandSet{

	public static final String ACTION = "OffAction";
	Logger logger = LoggerFactory.getLogger(OffAction.class);
