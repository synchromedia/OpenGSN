...
public class IStatAction extends AbstractActionWithCommandSet{

	public static final String ACTION = "IStatAction";
	Logger logger = LoggerFactory.getLogger(IStatAction.class);
