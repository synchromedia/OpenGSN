 ...
 *
 */
public class ServerTechBootstrapper implements IResourceBootstrapper{
	...
	private Logger logger = LoggerFactory.getLogger(ServerTechBootstrapper.class);
	...
	public void bootstrap(IResource engineIdentifier) throws ResourceException{
		...
		String response = client.executeAction("OStatAction", null);
		logger.debug("********* Reveived response: "+ response + "\n");
		
		response = client.executeAction("IStatAction", null);
		logger.debug("********* Reveived response: "+ response + "\n");
