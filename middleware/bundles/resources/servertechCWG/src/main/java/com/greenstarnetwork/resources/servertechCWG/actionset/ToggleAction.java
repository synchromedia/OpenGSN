...
public class ToggleAction extends AbstractActionWithCommandSet{

	public static final String ACTION = "ToggleAction";
	Logger logger = LoggerFactory.getLogger(ToggleAction.class);
	...
	private void initializeCommandsList(){
		...
		commandsList.add("ToggleCommand");
