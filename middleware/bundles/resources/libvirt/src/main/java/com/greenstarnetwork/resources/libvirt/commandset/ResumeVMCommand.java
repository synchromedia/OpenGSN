...
/**
 * Resume a VM which is paused
 * @author knguyen
 *
 */
public class ResumeVMCommand extends BasicCommand {
	
	public static final String COMMAND = "ResumeVMCommand";
	...
	public void executeCommand() throws CommandException {
		...
		}else
		{
			...
			if (vmName == null)
				throw new CommandException("Need VM name parameter for ResumeVM command!");
			boolean found = false;
...
//				throw new CommandException("VM: " + vmName + " is running!");
			...
			sendCommandToProtocol("virsh -c qemu:///system resume " + vmName);
		}
	...
	public void parseResponse(IResourceModel model) throws CommandException {
		...
		if (s.indexOf("error:") > -1)
			throw new CommandException("ResumeVMCommand exception: " + s);
