...
/**
 * Set state to a given VM
 * @author knguyen
 *
 */
public class SetVMStatusCommand extends AbstractCommand{

	public static final String COMMAND = "SetVMStatusCommand";
	
	private VmHostModel hostmodel = null;
	
	public SetVMStatusCommand() {
		super(COMMAND);
	}
	...
	public void executeCommand() throws CommandException {
		...
		}else
		{
			...
			if (!args.containsKey((String)"vmName"))
				throw new CommandException("Need VM name parameter for SetVMStatus command!");
			if (!args.containsKey((String)"status"))
				throw new CommandException("Need state for SetVMStatus command!");
			...
			vm.setStatus((String)args.get((String)"status"));
		}
	}

	public synchronized void setModel(VmHostModel m) {
		this.hostmodel = m;
		
	}
	
	@Override
	public synchronized void initializeCommand(IResourceModel arg0) throws CommandException {
