 ...
 *
 */
public class DestroyCommand extends BasicCommand {
	
	public static final String COMMAND = "DestroyCommand";
	...
	public void executeCommand() throws CommandException {
		...
		}else
		{
			...
			sendCommandToProtocol("virsh -c qemu:///system destroy " + vmName);
		}
	...
	public void parseResponse(IResourceModel model) throws CommandException {
		...
		if (s.indexOf("error:") > -1)
			throw new CommandException("DestroyCommand exception: " + s);
