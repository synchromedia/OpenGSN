 ...
 *
 */
public class HostInfoAction extends BasicAction{

	public static final String ACTION = "HostInfoAction";
	
	public HostInfoAction() {
		super(ACTION);
	...
	private void initializeCommandsList(){
		...
		commandsList.add(NodeInfoCommand.COMMAND);
