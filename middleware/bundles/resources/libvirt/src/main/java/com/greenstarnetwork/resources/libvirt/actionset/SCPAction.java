...
/**
 * TODO EXPORT
 * Copy an image of a VM to a host in a remote cloud
 * @author knguyen
 *
 */
public class SCPAction extends BasicAction {
	public static final String ACTION = "SCPAction";
	...
	private void initializeCommandsList(){
		...
		commandsList.add(SCPCommand.COMMAND);
