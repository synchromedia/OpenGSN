...
/**
 * Rename a template
 * mv command is called in order to create a copy of the template
 * @author knguyen
 *
 */
public class RenameTemplateCommand extends BasicCommand {
	
	public static final String COMMAND = "CopyTemplateCommand";
	
	public RenameTemplateCommand() {
		super(COMMAND);
	}
	...
	public void executeCommand() throws CommandException {
		...
		}else
		{
			...
			String command = "mv " + vmTemplateDiskImage + " " + vmDiskImage;
