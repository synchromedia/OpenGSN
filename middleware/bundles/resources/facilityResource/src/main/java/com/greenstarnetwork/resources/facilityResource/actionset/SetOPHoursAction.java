...
public class SetOPHoursAction extends BasicAction{

	public static final String ACTION = "SetOPHoursAction";

	public SetOPHoursAction() {
		super(ACTION);
	...
	private void initializeCommandsList(){
		...
		commandsList.add(SetOPHoursCommand.COMMAND);
