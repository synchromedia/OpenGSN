...
@Command(scope = "gsn-facility", name = "calculateOPSpecs", description="CalculateOPSpecs KARAF Command")
public class CalculateOPSpecsShellCommand extends OsgiCommandSupport {
	...
	protected Object doExecute() throws Exception {
		System.out.println("Command syntax: calculateOPSpecs <facilityResourceID>");
		if (facilityResourceID==null){
			...
			Logger.getLogger().begin(OPSpecsCalculateAction.ACTION);
			String response = client.executeAction(OPSpecsCalculateAction.ACTION, args);
			Logger.getLogger().end(OPSpecsCalculateAction.ACTION+ " "+response );
