...
/**
 * 
 * Set op-hou threshold of a given facility
 * 
 * 
 */
...
public class SetOPHourThresholdsAction extends BasicAction{

	public static final String ACTION = "SetOPHourThresholdsAction";

	public SetOPHourThresholdsAction() {
		super(ACTION);
	...
	private void initializeCommandsList(){
		...
		commandsList.add(SetOPHourThresholdsCommand.COMMAND);
