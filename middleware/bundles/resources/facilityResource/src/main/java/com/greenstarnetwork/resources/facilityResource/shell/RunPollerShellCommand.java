...
@Command(scope = "gsn-facility", name = "runPoller", description="RunPoller KARAF Command")
public class RunPollerShellCommand extends OsgiCommandSupport {
	...
	protected Object doExecute() throws Exception {
		System.out.println("Command syntax: runPoller <facilityResourceID> ");
		if (facilityResourceID==null){
			...
			Logger.getLogger().begin(PollerAction.ACTION);
			String response = client.executeAction(PollerAction.ACTION, args);
			Logger.getLogger().end(PollerAction.ACTION+ " "+response );
