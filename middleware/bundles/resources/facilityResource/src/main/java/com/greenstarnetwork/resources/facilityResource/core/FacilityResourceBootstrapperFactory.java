...
/**
 * 
 * create bootstrapper instances for facility resource.
 * 
...
public class FacilityResourceBootstrapperFactory implements IResourceBootstrapperFactory{

	public IResourceBootstrapper createResourceBootstrapper() {
		return new FacilityResourceBootstrapper();
	}
