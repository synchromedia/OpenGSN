 ...
 */
package com.greenstarnetwork.services.facilitymanager.messages;
 ...
 * 
 */
public class FacilityManagerListener implements MessageListener {
	Logger logger = LoggerFactory.getLogger(FacilityManagerListener.class);
