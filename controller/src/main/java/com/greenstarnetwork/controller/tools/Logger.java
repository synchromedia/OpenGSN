...
/**
 * Recording log information of the Controller. Information is written to a
 * simple text file. Each line has the following format:
...
public class Logger {
	...
	public static String IAAS_HOME = "IAAS_HOME"; // environment variable - path
													// to IAAS home
	public static String LOG_DIR = "/gsn/controller/"; // default log file
	public static String LOG_FILE = "Controller"; // default log file
	public static String LOG_EXTENSION = ".log"; // default log file

	private static Logger logger = null; // singleton object
	...
	private void openFile() throws IOException {
		try {
			...
			checkDir(ih + LOG_DIR);
			String log_file = ih + LOG_DIR + LOG_FILE + this.getCurDate()
					+ LOG_EXTENSION;
			...
			System.err.println("Error starting logger " + e.getMessage());
			e.printStackTrace();
		}
	}
