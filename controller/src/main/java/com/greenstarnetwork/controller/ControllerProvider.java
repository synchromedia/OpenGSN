 ...
 */
package com.greenstarnetwork.controller;
...
import com.greenstarnetwork.controller.executor.ExecutionPlan;
import com.greenstarnetwork.controller.executor.Executor;
import com.greenstarnetwork.controller.generator.HostParamGenerator;
import com.greenstarnetwork.controller.generator.LinkParamGenerator;
import com.greenstarnetwork.controller.manager.CloudManagerClient;
import com.greenstarnetwork.controller.manager.FacilityManagerClient;
import com.greenstarnetwork.controller.model.Host;
import com.greenstarnetwork.controller.model.HostList;
import com.greenstarnetwork.controller.model.LinkTable;
import com.greenstarnetwork.controller.model.MigrationPlan;
import com.greenstarnetwork.controller.plan.AggregatedPlanGenerator;
import com.greenstarnetwork.controller.tools.InetAddressUtil;
import com.greenstarnetwork.controller.tools.LogManager;
...
public class ControllerProvider implements IControllerProvider {
	...
	private Logger log = null;				//controller state logger
	...
	public void connect() {
//		loadCXF();
		log.debug("connecting to Managers...");
		setCloudManager(new CloudManagerClient());
		setFacilityManager(new FacilityManagerClient());
		log.debug("Connected");
	}
	 ...
	 */
	/* TODO Commented out by Scott - I'm guessing this is old and we dont' need it.
