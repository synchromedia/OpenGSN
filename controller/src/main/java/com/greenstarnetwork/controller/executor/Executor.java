...
import com.greenstarnetwork.controller.model.Link;
...
public class Executor {
	...
	private IControllerProvider controller = null;
	
	private boolean executing = false;			//0: idle; 1: executing 
	
	public Executor(IControllerProvider parent) {
	...
	{
		if (controller.getMode() == IControllerProvider.REAL_MODE) {
//			try {//wait for previous synchronization
//				Thread.sleep(10000);
//			}catch (Exception e) {};
			return this.controller.getCloudManager().migrateVM(hostId, vmName, destinationHostId);
		}
